  ...
  <script type="text/javascript">
    ...
    showListDataCourse = () => {
        $.ajax({    
              type: "GET",
              url: "<?php echo base_url();?>App/list_data_my_bimbel",             
              dataType: "JSON",             
                        ...
                        '<div class="card card-profile">'+
                          '<div class="row justify-content-center">'+
                            '<div class="col-4 col-lg-4 order-lg-2">'+
                              '<div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">'+
                                '<a>'+
                                  '<img src="<?= base_url() ?>assets/app/images/course/'+data[i].course_banner+'" class="rounded-circle img-fluid border border-2 border-white">'+
                                '</a>'+
                              '</div>'+
                            '</div>'+
                          '</div>'+
    ...
    confirmDo = (id) => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
             location.href = "<?= base_url() ?>bimbel/do/"+id;
          }
        });
    }
  </script>