                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Package Banner <button id="show-banner">Show</button></label>
  ...
  <script type="text/javascript">
      ...
      document.getElementById('show-banner').addEventListener("click", function() {
        Swal.fire({
          imageUrl: "<?= base_url() ?>/assets/app/images/course/"+packageBannerName,
      ...
      showListData = () => {
        $.ajax({    
              type: "GET",
              url: "<?php echo base_url();?>App/list_data_m_package_search_by_id",             
              dataType: "JSON",
              data : {
      ...
      setValueToForm = (data) => {
          ...
          $('#package-status').val(data.package_status);
          $('#package-type').val(data.package_type);
          $('#package-nominal').val(data.package_nominal);
          $("#package-description").summernote('code',data.package_description);
          packageBannerName = data.package_banner;
          showListDataIncludes(data.list_course);
      }
      ...
      showListDataIncludes = (list_course) => {
        $.ajax({    
              type: "GET",
              url: "<?php echo base_url();?>App/list_data_m_course",             
              dataType: "JSON",             
              success: function(data){  
                writeListOptionIncludes(data, list_course);     
              }
          });
      }
      ...
      writeListOptionIncludes = (data, list_course) => {
          ...
          if(data.length > 0) {
              for (var i = 0; i < data.length; i++) {
                var valSelec = "";
                const foundObject = list_course.find(obj => obj.id_course === data[i].id_course);
                if (foundObject) {
                    valSelec = "selected";
                }
                 result += "<option "+valSelec+" value='"+data[i].id_course+"'>"+data[i].course_name+"</option>";
              }
          }
      ...
      validateAdd = () => {
        ...
        let result = "";
        if (packagename === "" || packagestatus === "" || packagenominal === "" || packagedescription || packagetype === "" || packageincludes.length < 1){
          ...
          if (packagebanner !== ""){
            ...
            oldPhoto = true;
            var checkUpload = packageBannerName;
          }
          if(checkUpload !== ""){
            let data = {
      ...
      sendDataToDB = (dataSend, condition) => {
          $.ajax({
          type: "POST", 
          url: "<?php echo base_url('App/sendDataEditPackageToDB')?>",
          data:  {
